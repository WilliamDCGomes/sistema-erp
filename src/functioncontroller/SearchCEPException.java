 ...
 */
public class SearchCEPException extends Exception {
    private String CEP;
     ...
     */
    public SearchCEPException(String message, String classe) {
        super(message);
     ...
     * @param classe classe da excessão original
     */
    public SearchCEPException(String message, String cep, String classe) {
        super(message);
