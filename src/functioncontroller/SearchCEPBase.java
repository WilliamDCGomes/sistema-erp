 ...
 * @author PABLO
 */
public abstract class SearchCEPBase {
    // pripriedades do CEP
    ...
    // váriaveis internas
    protected SearchCEPEvents Events;
    
    public SearchCEPBase () {
        CEPs = new ArrayList<>();
        index = -1;
    ...
    // métodos abstratos
    public abstract void buscar(String cep) throws SearchCEPException;
    public abstract void buscarCEP(CEP cep) throws SearchCEPException;
     ...
     * @throws functioncontroller.SearchCEPException
     */
     ...
     */
    public final String getHttpGET(String urlToRead) throws SearchCEPException {
        ...
        try {
            ...
            throw new SearchCEPException(ex.getMessage(), ex.getClass().getName());
     ...
     * @throws SearchCEPException em caso de erro
     */
    protected String formatStringToUri(String string) throws SearchCEPException {
        String out = null;
        ...
        if (string != null && !string.isEmpty()) {
            try {
                ...
                throw new SearchCEPException("Não foi possível codificar o valor solicitado!", UnsupportedEncodingException.class.getName());
            }
        } else {
            throw new SearchCEPException("Valor nulo ou vazio informado!", String.class.getName());
        }
