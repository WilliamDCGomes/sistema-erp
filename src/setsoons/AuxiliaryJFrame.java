 ...
 * @author willi
 */
public class AuxiliaryJFrame extends javax.swing.JFrame {
    public AuxiliaryJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AuxiliaryJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AuxiliaryJFrame().setVisible(true);
            }
        });
    }
