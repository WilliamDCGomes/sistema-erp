...
import callframes.MakeLogoutOrCloseSystem;
...
import screens.findfiles.LocaleManual;
import screens.findfiles.LocaleOS;
import screens.findfiles.LocaleOrder;
import screens.files.editfiles.ScreenUser;
/**
 *
 * @author willi
 */
public class MainMenu extends javax.swing.JFrame {
    ...
    private void makeLogout(){
        MakeLogoutOrCloseSystem makeLogout = new MakeLogoutOrCloseSystem();
        makeLogout.makingLogout();
    }
    ...
    private void initComponents() {
        ...
        buttonFindOS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/addOrder.png"))); // NOI18N
        ...
        buttonOrder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/order.png"))); // NOI18N
        ...
        buttonAddOS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/addOS.png"))); // NOI18N
        ...
        buttonEditOS.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/editOS.png"))); // NOI18N
        ...
        buttonStock.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/stock.png"))); // NOI18N
        ...
        buttonAddOS1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/addOS.png"))); // NOI18N
    ...
    private void optPartsOver7DaysActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optPartsOver7DaysActionPerformed
        ...
        backlogOS.txtScreenBacklog.setText("Peças e Módulos Acima de 7 Dias");
        backlogOS.setTitle("Peças e Módulos Acima de 7 Dias");
    ...
    private void optMoreRequestesItemsStockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optMoreRequestesItemsStockActionPerformed
        ...
        allParts.txtAllParts.setText("Peças mais Requisitadas");
        allParts.setTitle("Peças mais Requisitadas");
    ...
    private void optFindManualActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optFindManualActionPerformed
        LocaleManual localeManual = new LocaleManual();
        callOtherScreen(localeManual);
    ...
    private void optLocalizeOSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_optLocalizeOSActionPerformed
        LocaleOS localeOS = new LocaleOS();
        callOtherScreen(localeOS);
    ...
    private void opcCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_opcCloseActionPerformed
        MakeLogoutOrCloseSystem makeLogoutOrCloseSystem = new MakeLogoutOrCloseSystem();
        makeLogoutOrCloseSystem.closeSystem();
    ...
    private void txtAddOSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtAddOSMouseClicked
        CadastreOS cadastreOS = new CadastreOS();
        callOtherScreen(cadastreOS);
